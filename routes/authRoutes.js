...
const {createUser, loginUser, getAllUser, getUser, deleteUser, updateUser, blockUser, unblockUser, handleCookie, logOut, changePassword, forgetPasswordToken}= require('../controller/userCtrl');
